...
**Resume** — open **`/login`** (Lambda OTP → CodeBuild wake → `/handoff` session cookie) or **Deploy to AWS dev** (`workflow_dispatch`) / push a `v*.*.*` tag. Workflow map: [ci-workflows.md](../../docs/developer/ci-workflows.md).
