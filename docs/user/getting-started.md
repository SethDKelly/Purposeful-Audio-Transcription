...
|-------------|------------|
| **Asleep / paused** (v2.1 power control) | Open ALB **`/login`**, enter an invite-only email, verify the SES code. Stay on that page until it signs you in (handoff → session cookie → `/`). Cold start often 5–15+ minutes. |
