...
2. Execute the current band (today: **v2 foundation complete**; deeper v2 items next).
...
| [09_v2_0_foundation_execution.md](09_v2_0_foundation_execution.md) | v2 readiness foundation slice — **complete** |
