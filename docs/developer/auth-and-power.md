...
> Documents the v2.1 auth/power deploy path (PR #16) and the wake handoff cookie exchange (PR #18). Verified against `backend/api/routes/auth.py`, `power.py`, `infra/lambda/power_control/handler.py`, `frontend-react/src/components/AppShell.tsx`, and deploy/pause workflows.
