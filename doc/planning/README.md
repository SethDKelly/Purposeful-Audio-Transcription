...
Active planning for the **Relationship Reasoning Engine** after v0.6.0.
...
| Document | Purpose |
|----------|---------|
| [../architecture/ontology_v1.md](../architecture/ontology_v1.md) | Canonical construct & relationship vocabulary (v0.7) |
| [../architecture/structured_persistence_plan.md](../architecture/structured_persistence_plan.md) | Normalized findings/constructs/graph (v0.8) |
| [../architecture/workflow_dag_plan.md](../architecture/workflow_dag_plan.md) | DAG workflow engine (v1.0) |
| [../product/transcript_preparation_workspace.md](../product/transcript_preparation_workspace.md) | Transcript review before analysis (v0.7) |
| [../product/safety_aware_report_mode.md](../product/safety_aware_report_mode.md) | High-risk report framing (v1.0) |
| [../evaluation/golden_fixture_evaluation_plan.md](../evaluation/golden_fixture_evaluation_plan.md) | Fixtures & eval loop (v0.7) |
